                ...
                <div className="flex border border-black rounded-full p-3 shadow-lg cursor-pointer">
                    <svg width="45" height="24" viewBox="0 0 45 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_122_24)">
                            <path fill-rule="evenodd" clipRule="evenodd" d="M22.4999 6.38C26.7249 6.38 29.5749 7.71833 31.1999 8.83667L37.5499 4.29C33.6499 1.63167 28.5749 0 22.4999 0C13.6999 0 6.0999 3.70333 2.3999 9.09333L9.6749 13.2367C11.4999 9.25833 16.5499 6.38 22.4999 6.38Z" fill="#EA4335"/>
                            <path fill-rule="evenodd" clipRule="evenodd" d="M44.1 16.8667C44.1 15.51 43.95 14.52 43.625 13.4933H22.5V19.6167H34.9C34.65 21.1383 33.3 23.43 30.3 24.97L37.4 29.0033C41.65 26.125 44.1 21.89 44.1 16.8667Z" fill="#4285F4"/>
                            <path fill-rule="evenodd" clipRule="evenodd" d="M9.7 19.7633C9.225 18.7367 8.95 17.6367 8.95 16.5C8.95 15.3633 9.225 14.2633 9.675 13.2367L2.4 9.09332C0.875 11.33 0 13.8417 0 16.5C0 19.1583 0.875 21.67 2.4 23.9067L9.7 19.7633Z" fill="#FBBC05"/>
                            <path fill-rule="evenodd" clipRule="evenodd" d="M22.4998 33C28.5748 33 33.6748 31.5333 37.3998 29.0033L30.2998 24.97C28.3998 25.9417 25.8498 26.62 22.4998 26.62C16.5498 26.62 11.4998 23.7417 9.6998 19.7633L2.4248 23.9067C6.1248 29.2967 13.6998 33 22.4998 33Z" fill="#34A853"/>
                        </g>
                        <defs>
