                    ...
                    <div className="flex flex-col space-y-5">
                        ...
                        <div
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24"
                            ...
                            <Link to="/task"><span>Login</span> </Link>

                        <p className="text-center">Not registered yet? <div
                            className="text-orange-400 font-medium inline-flex space-x-1 items-center"><Link to="/signup"><span>Login here</span></Link><svg
