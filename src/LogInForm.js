        ...
        <div className="flex md:flex-row mx-auto w-1/5 mt-10">
            <form className="flex flex-col space-y-4">
                <div className="flex-1 border border-black rounded-full p-3 shadow-lg cursor-pointer">
                    <svg className="flex-1" width="45" height="24" viewBox="0 0 45 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                */}
                ...
                <p className="text-xs text-center">Don't have an account?<u
                    className="text-orange-500 underline pl-1 cursor-pointer">Sign up</u></p>
                <hr/>
