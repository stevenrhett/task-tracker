...
const HeaderComponent = () => {
    return (<div>
        <div
            className="flex flex-col md:flex-row justify-between items-center md:h-20 p-4 border-b-2 border-gray-300">
            <div className="font-bold text-teal-600 text-3xl">ULTRA<span className="text-orange-400">Task</span>
            </div>
            <div className="flex">
