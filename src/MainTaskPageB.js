...
const MainTaskPageB = () => {
    ...
    const ALL_TASK_DATA_API_URL = "https://edimwgfgsphnlyquzwnq.supabase.co/rest/v1/TaskB?select=*"
    const ALL_COMPLETED_API_URL = "https://edimwgfgsphnlyquzwnq.supabase.co/rest/v1/TaskB?completed=eq.true&select=*"
